...
const AddIngredient = ({groceryCategories, setGroceryCategories}) => {
    ...
    const onSubmit = ()=>{
        ...
        console.log(tempList, 'no zeros');
        tempList.forEach((cat) => {if (cat[0].category ===newIng.category){
            cat.push(newIng) 
            } else {
                tempList.push([newIng]);
        console.log(cat, 'cat')}});

        console.log(groceryCategories, 'groceryCategories');
